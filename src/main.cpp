...
// Copyright (c) 2017 The bkccoin developers
...
uint256 hashGenesisBlock("0x00000101c417102a79e9fa0f352e8844f075e3c02934e65eab1b1340123f52bf");
static const unsigned int timeGenesisBlock = 1515461936;
...
const string strMessageMagic = "bkccoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "August 15, 2017. The bkccoin release. ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04f435367958d44e34be2d6d90711946f42a81452ddfcbef22f356266a085b58c923770b514e188253d14eb126501be50d4ea8a36b72c862259b60b85fa4d5364b") << OP_CHECKSIG;
        CBlock block;
        ...
        block.nNonce   = 4436902;

        if (fTestNet)
        {
            block.nTime    = 1492164000;
            block.nNonce   = 122965;
        }
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xc970ff509a59f374fcc67e175dce019d2e8f9ed03ecd77f5b6b10dce291d2bd0"));
...
unsigned char pchMessageStart[4] = { 0xdf, 0xef, 0xad, 0x2f };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("bkccoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("bkccoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("bkccoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("bkccoin-miner");
    ...
    try { loop {
        ...
        printf("Running bkccoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("bkccoinMiner terminated\n");
        throw;
    }
}
