...
const QString BITCOIN_IPC_PREFIX("bkccoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click bkccoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start bkccoin: click-to-pay handler");
    else
...
{
    // clicking on bkccoin: URLs creates FileOpen events on the Mac:
